...
#define FOCUS           "#383838" /* focused window border color    */
...
static const char *appmenu[]    = { "mygtkmenu", NULL };
...
static const char *clipboardmngr[] = { "xcmenuctrl", NULL };
...
static Key keys[] = {
    ...
    {  MOD4,             XK_c,          spawn,             {.com = clipboardmngr}},
    {  MOD4,             XK_f,          spawn,             {.com = filecmd}},
    {  MOD4,             XK_t,          spawn,             {.com = editorcmd}},
